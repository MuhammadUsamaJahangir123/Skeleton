...
<body style="height: 620px">
    <form id="form1" runat="server">
        ...
        <br />
        <asp:CheckBox ID="chkActivity" runat="server" style="z-index: 1; left: 29px; top: 195px; position: absolute" Text="Active" />
        <br />
        ...
        <asp:TextBox ID="txtSupplierContact" runat="server" height="22px" style="z-index: 1; left: 127px; top: 147px; position: absolute" width="128px"></asp:TextBox>
        <p>
            <asp:Label ID="lblSupplierContact" runat="server" style="z-index: 1; left: 11px; top: 146px; position: absolute; right: 1363px" Text="Supplier Contact"></asp:Label>
