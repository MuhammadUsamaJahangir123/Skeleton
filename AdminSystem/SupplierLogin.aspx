...
<body style="height: 461px">
    <form id="form1" runat="server">
        <div style="height: 28px">
            <asp:Label ID="lblLoginPage" runat="server" style="z-index: 1; left: 51px; top: 44px; position: absolute" Text="Supplier Login Page"></asp:Label>
        </div>
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 307px; top: 283px; position: absolute; height: 26px;" Text="Cancel" OnClick="btnCancel_Click" />
    </form>
</body>
</html>
